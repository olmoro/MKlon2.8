...
#### <p align="right">редакция от 26 февраля 2023 года

![](https://github.com/olmoro/MKlon2v5/blob/main/Documents/Img/IMG_20230215_111532_MP.png)

![](https://github.com/olmoro/MKlon2v5/blob/main/Documents/Img/IMG_20230215_171011_MP.png)
...
![](https://github.com/olmoro/MKlon2v5/blob/main/Documents/Img/interprocessor.png)
...
![](https://github.com/olmoro/MKlon2v5/blob/main/Documents/Img/ui_measure.png)
...
![](https://github.com/olmoro/MKlon2v5/blob/main/Documents/Img/i_discharge.png)
MKlon2. Как это работает. Схема разряда.

Измерение тока разряда производится на том же шунте RS, что и ток заряда, исключая неоднозначность при подсчете залитых и слитых ампер-часов. Для облегчения теплового режима предусмотрен разъем для подключения внешней нагрузки. В случае отсутствия таковой ток ограничивается двухваттным резистором R54. В режиме заряда при чрезмерно малой нагрузке силовой DC/DC автоматически подгружается этим резистором для обеспечения его устойчивой работы, причем этот ток не фиксируется шунтом.

***

![](https://github.com/olmoro/MKlon2v5/blob/main/Documents/Img/switch.png)
...
![](https://github.com/olmoro/MKlon2v5/blob/main/Documents/Img/power.png)
...
![](https://github.com/olmoro/MKlon2v5/blob/main/Documents/Img/dc_dc.png?raw=true)
...
![](https://github.com/olmoro/MKlon2v5/blob/main/Documents/Img/cooler.png)
...
![](https://github.com/olmoro/MKlon2v5/blob/main/Documents/Img/usb.png)
MKlon2. Как это работает. USB интерфейс.
...
На середину февраля 2023 идет отладка прибора с платой версии MKlon2v7a. По мере испытаний документация корректируется и выкладывается здесь. Платами могу поделиться. 
...
![](https://github.com/olmoro/MKlon2v5/blob/main/Documents/Img/DS18D20_4.jpg) - пока это только в планах.
