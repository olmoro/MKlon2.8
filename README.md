...
Получить параметры преобразования можно достаточно просто, сняв показания по точкам, введя в [онлайн-калькулятор](https://planetcalc.ru/) и выбрав подходящую регрессию.
