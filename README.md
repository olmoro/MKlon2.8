...
Получить параметры преобразования можно достаточно просто, сняв показания по точкам, введя в [онлайн-калькулятор](https://planetcalc.ru/5992/) и выбрав подходящую регрессию.
