...
А во-вторых, "сглаживание" не работает, если изменения тока или напряжения нет. Разрешение в таком случае "родное", 11-разрядное. Что сводит к нулю выгодоприобретение в виде 16-разрядного результата.
