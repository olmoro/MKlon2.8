...
SBUTTON_CLICK SButton::Loop() {
  ...
  //uint16_t dt = ms - Ms1;
    ...
    Auto_press_state = false;
#ifdef DEBUG_BUTTON
    Serial.print(">>>Event button, pin=");    Serial.print(Mark);
    Serial.print(",press ON, tm=");           Serial.print(ms - Ms1);   Serial.println(" ms");
#endif
    State = true;
    Ms2   = ms;
...
#ifdef DEBUG_BUTTON
    Serial.print(">>>Event button, pin=");    Serial.print(Mark);
    Serial.print(",long press, tm=");         Serial.print(ms - Ms2);    Serial.println(" ms");
#endif
  ...
  //uint16_t dt      = ms - Ms2;
    ...
    Ms_auto_click    = ms;
#ifdef DEBUG_BUTTON
    Serial.print(">>>Event button, mark=");     Serial.print(Mark);
    Serial.print(",auto press, tm=");           Serial.print(ms - Ms2);   Serial.println(" ms");
#endif
...
#ifdef DEBUG_BUTTON
    Serial.print(">>>Event button, mark=");     Serial.print(Mark);
    Serial.print(",press OFF, tm=");            Serial.print(ms - Ms2);   Serial.println(" ms");
#endif
    Ms1    = ms;
